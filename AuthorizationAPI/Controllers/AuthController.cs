...
namespace AuthorizationAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IConfiguration config,IUserRepo _repo,UserContext userContext)
        {
            _config = config;
            repo = _repo;
            userContext = context;
        ...
        public IActionResult Register([FromBody] UserCredentials reg)
        {
         ...
         //public UserCredentials getuserdetails(int id)
         //{
         //    var user = context.UserDetails.Find(i=>i.id==id);
         //    return user;
         //}
